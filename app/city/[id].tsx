      ...
      current
        ? {
            ...
            sights: current.sights?.map((sight) =>
              sight.id === sightId ? { ...sight, completed: next } : sight,
            ),
          }
        : current,
    );
        ...
        {city ? (
          <>
                ...
                items={[
                  {
                    ...
                    value: cityVisits.length,
                    label: "VISITS",
                  },
                  {
                    icon: "camera-outline",
                    value: completedCitySightCount,
                    label: "SIGHTS",
                  },
                  {
            ...
            <View style={s.list}>
              ...
              {!visitedAirports.length ? (
                <Text style={s.empty}>
                  Your visited airports in {city.name} will appear here.
                </Text>
              ) : null}
            </View>
            ...
            <View style={s.list}>
              ...
              {!cityVisits.length ? (
                <Text style={s.empty}>
                  Your visits to {city.name} will appear here.
                </Text>
              ) : null}
            </View>
            <PlaceCollectionList
