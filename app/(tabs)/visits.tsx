...
const styles = StyleSheet.create({
  ...
  emptyTitle: { marginTop: 14, fontFamily: "Lora_600SemiBold", fontSize: 24, color: BrandColors.onDark },
  ...
  sheetTitle: { fontFamily: "Lora_700Bold", fontSize: 27, color: BrandColors.ink },
